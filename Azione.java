...
public class Azione {
    ...
    public Map<Operatore, Integer> getAllocazioni() {
        ...
        return result; // Restituisce una copia per evitare modifiche esterne
    }

    public void assegnaAzioni(Operatore operatore, int quantita) {
        if (quantita > numeroDisponibili) {
            throw new IllegalArgumentException("Quantità di azioni non disponibile.");
        }
    ...
    public void aggiornaNumeroDisponibili(int variazione) {
        this.numeroDisponibili += variazione;
    }
